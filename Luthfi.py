...
def setting():
	...
	if password_metode in ['1','01']:
		...
		print(f" [%] input hanya dengan angka,jangan kosong.")
		exit()
###-----[ SETTING PASSWORD OTOMATIS LUTHFI]-----###
def Otomatis():
...
###-----[ SETTING PASSWORD MANUAL LUTHFI ]-----###
def Manual():
